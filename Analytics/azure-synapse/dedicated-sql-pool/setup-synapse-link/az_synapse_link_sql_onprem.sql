...
IF DB_ID('az_synapse_link') IS NULL
CREATE DATABASE az_synapse_link
GO
...
IF EXISTS(SELECT 1 FROM sys.tables WHERE name ='Product_OnPrem' AND schema_id=schema_id('dbo'))
DROP TABLE [dbo].[Product_OnPrem]
GO


--Create table if exists
CREATE TABLE [dbo].[Product_OnPrem](
...
INSERT INTO [dbo].[Product_OnPrem]
...
/* 
	Second Insert
*/
ALTER TABLE [dbo].[Product_OnPrem]
...
SELECT * FROM [dbo].[Product_OnPrem]
GO