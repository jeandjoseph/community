...
UPDATE [base].[Product] set SalesRep='johndoe@yourdomain.com'
...
SELECT 1,'1010-GL120-3C','Trainer - Tailspin GL-120','Glider','Airplane','RTF',3,'Novice',79.15,'johndoe@yourdomain.com' UNION
SELECT 2,'1010-GL155-4C','Trainer - Tailspin GL-155','Glider','Airplane','RTF',4,'Intermediate',216.65,'johndoe@yourdomain.com' UNION
SELECT 3,'2030-PCUB-3C','Piper Cub 3 Channel','Trainer','Airplane','RTF',3,'Beginner',84.65,'johndoe@yourdomain.com' UNION
...
INSERT INTO [base].[Product]
SELECT 11,'3010-TAVM2-15-4C','Tailspin Aviator Mk2-15','Trainer','Airplane','KIT',4,'Intermediate',204.55, 'johndoe@yourdomain.com' UNION
SELECT 12,'3010-TWAR-BM32-5C','Tailspin Warbird BM32','Warbird','Airplane','KIT',5,'Advanced',349.75, 'johndoe@yourdomain.com' UNION
...
CREATE TABLE clone.Product_restored AS CLONE OF [base].[Product] AT '2025-01-17T20:47:53.840';
GO
...
-- APPLY ROWS, COLUMNS AND DATA MASKING DATA LEVEL SECURITY
-- Apply Colomn Level Security
-- NO access on [ProductName], [RetailPrice], [SalesPrep]
GRANT SELECT TO [johndoe@yourdomain.com];
GO

DENY SELECT ON [base].[Product] TO [johndoe@yourdomain.com];
GO
...
GRANT SELECT ON rls.tvf_securitypredicate TO [johndoe@yourdomain.com];  
...
GRANT SELECT ON [base].[Product] TO [johndoe@yourdomain.com];
GO
